...
<link href="inventoryregion.css" rel="stylesheet">
  ...
  <div class="editRequest" id="editrequest">
        <form action="" method="POST">
            ...
            id="close"><a href="moedashboard.php">&times;</a> </span> 
            ...
            <input type="text" id="schoolcode" name="schoolcode" value="<?php echo $row["schoolcode"];?>" readonly><br><br>
